...
//=========  (Tue Mar 19 21:01:10 2019) by ROOT version6.02/05
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_PFNo31dDijet2017bgDeepCSV1bM");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"p1_PFNo31dDijet2017bgDeepCSV1bM");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"p2_PFNo31dDijet2017bgDeepCSV1bM");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"p3_PFNo31dDijet2017bgDeepCSV1bM");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_PFNo31dDijet2017bgDeepCSV1bM");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"p1_PFNo31dDijet2017bgDeepCSV1bM");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"p2_PFNo31dDijet2017bgDeepCSV1bM");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"p3_PFNo31dDijet2017bgDeepCSV1bM");
