...
for i in csv_list:
  ...
  gr['le1'][i].SetTitle(' CSVv2 tagging power in 4 Catagories for 2017 b*')
  gr['le1'][i].Draw('APL')
...
for i in ['1','le1','2']:
  ...
  for j in csv_list:
     ...
     if index == 1:
       ...
       gr[i][j].SetTitle('Several CSVv2 bTag Point of '+i+'b Catagory of 2017 b*')
       gr[i][j].Draw()
