...
#    CSV_Value = [0.05,0.1,0.1522,0.2,0.25,0.3,0.35,0.4,0.45,0.4941,0.5803,0.6,0.65,0.7,0.75,0.8,0.85,0.8838,0.9693]
    ...
    outFolder = "signalHistos_"+flavour+'_Feb_For2017Scan_DeepJet_WithoutInter_'+su
    ...
    for i,j in CSV_Value.items(): 
      ...
      g_mtbtag_rate_Q=g_mtbtag_rate[i]
      g_1btag_rate_Q=g_1btag_rate[i]
      g_2btag_rate_Q=g_2btag_rate[i]
      g_le1btag_rate_Q=g_le1btag_rate[i]
