...
4000:'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/2017JetHT_reduced/bstar2bg/4000GeV_reduced_skim.root',
5000:'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/2017JetHT_reduced/bstar2bg/5000GeV_reduced_skim.root',
6000:'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/2017JetHT_reduced/bstar2bg/6000GeV_reduced_skim.root',
7000:'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/2017JetHT_reduced/bstar2bg/7000GeV_reduced_skim.root',
8000:'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/2017JetHT_reduced/bstar2bg/8000GeV_reduced_skim.root',
9000:'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/2017JetHT_reduced/bstar2bg/9000GeV_reduced_skim.root',
                  }
...
def QuaInter(F):
  def Func(x):
     z = 0
     mass = [750.0,1000.0,2000.0,3000.0,4000.0,5000.0,6000.0,7000.0,8000.0,9000.0]
     for i in mass:
        term = 1.0
...
def bookAndFill(mass,sample,flavour):
    ...
    hDict["h_mass_passed_le1b"] = rt.TH1F(prefix+"_mass_passed_le1b",prefix+"_mass_passed_le1b",massRange[mass][0],massRange[mass][1],massRange[mass][2])
    hDict["h_mass_passed_le1b"].SetLineColor(rt.kGreen)
    hDict["h_mass_passed_le1b"].SetMarkerColor(rt.kGreen)
    hDict["h_mass_passed_le1b"].SetMarkerSize(0.5)
...
#	if tchain.nBjets_t >= 1:
#            hDict["h_mass_passed_le1b"].Fill(tchain.mjj)
...
if __name__ == '__main__':
    ...
    g_le1btag_rate = rt.TGraphAsymmErrors()
    g_le1btag_rate.SetMarkerColor(rt.kGreen)
    g_le1btag_rate.SetLineColor(rt.kGreen)
    g_le1btag_rate.SetLineWidth(2)
    ...
    g_le1btag_weight = rt.TGraphAsymmErrors()
    ...
    for mass,hDict in sorted(mDict.iteritems()):
        ...
        num = hDict["h_mass_passed_le1b"].GetSumOfWeights()
        g_le1btag_rate.SetPoint(bin,mass,num/den) 
...
#        hDict["h_mass_passed_2b"].DrawNormalized("sames")
        ...
        leg.AddEntry(hDict["h_mass_passed_le1b"],"le1-tag","P")
...
#        leg.Draw("same")
    ...
    g_0btag_rate_Q=Do_Inter(g_0btag_rate)
    g_1btag_rate_Q=Do_Inter(g_1btag_rate)
    g_2btag_rate_Q=Do_Inter(g_2btag_rate)
    g_le1btag_rate_Q=Do_Inter(g_le1btag_rate)

    g_an_acc.Write("g_an_acc")

    g_0btag_rate_Q.Write("g_0btag_rate")
    g_0btag_rate_Q.SetMarkerColor(rt.kBlack)
    ...
    leg = rt.TLegend(0.75, 0.63, 0.96, 0.74)
    leg.AddEntry(g_0btag_rate_Q,"0-tag","L")
    leg.AddEntry(g_le1btag_rate_Q,">=1-tag","L")
