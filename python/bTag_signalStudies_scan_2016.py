...
#CSV_Value = [0.1522,0.2219,0.3,0.35,0.4,0.35,0.4941,0.5426,0.5803,0.6324,0.7,0.75,0.8001,0.8484,0.8838,0.8958,0.9535,0.9693]
...
if __name__ == '__main__':
    ...
    outFolder = "signalHistos_"+flavour+'_Jun12_For2016Scan_deep'
