...
if __name__=='__main__':
  ...
  for i in CSV_Value :
    os.system('python python/bTag_Add.py -u '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(i*1000))+'_JESUP_Interpolation_rescale.root -d '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(i*1000))+'_JESDOWN_Interpolation_rescale.root -r '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(i*1000))+'_JER_Interpolation_rescale.root -n '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(i*1000))+'_Nominal_Interpolation_rescale.root -g inputs/JetHT_run2016_moriond17_red_cert_v2_scan.root -b '+tag+str(int(i*1000))+' -H  h_mjj_btag'+catagory+'_mybtag_'+str(format(i*100,'.1f')))
