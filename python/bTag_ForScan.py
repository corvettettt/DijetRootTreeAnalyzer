...
#}
  ...
  for i,j in enumerate(CSV_Value) :    
    if '2016' in tag:
      if 'DeepCSV' in tag:
         os.system('python python/bTag_Add_2016.py -u '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESUP_Interpolation_rescale.root -d '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESDOWN_Interpolation_rescale.root -r '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JER_Interpolation_rescale.root -n '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_Nominal_Interpolation_rescale.root -g inputs/JetHT_run2016_red_cert_scan.root -b '+tag+catagory+str(int(j*1000))+' -H h_mass_passed_'+catagory+'_DeepCSV_'+str(format(j*1000,'.1f')))
      elif 'CSVv2' in tag:
         os.system('python python/bTag_Add_2016.py -u '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESUP_Interpolation_rescale.root -d '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESDOWN_Interpolation_rescale.root -r '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JER_Interpolation_rescale.root -n '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_Nominal_Interpolation_rescale.root -g inputs/JetHT_run2016_red_cert_scan.root -b '+tag+catagory+str(int(j*1000))+' -H h_mass_passed_'+catagory+'_CSVv2_'+str(format(j*1000,'.1f')))
      elif 'DeepJet' in tag: 
         os.system('python python/bTag_Add_2016.py -u '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESUP_Interpolation_rescale.root -d '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESDOWN_Interpolation_rescale.root -r '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JER_Interpolation_rescale.root -n '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_Nominal_Interpolation_rescale.root -g inputs/JetHT_run2016_red_cert_scan.root -b '+tag+catagory+str(int(j*1000))+' -H h_mass_passed_'+catagory+'_DeepJet_'+str(format(j*1000,'.1f')))


    if '2017' in tag:
      if 'DeepCSV' in tag:
        os.system('python python/bTag_Add_2017.py -u '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESUP_Interpolation_rescale.root -d '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESDOWN_Interpolation_rescale.root -r '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JER_Interpolation_rescale.root -n '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_Nominal_Interpolation_rescale.root -g inputs/JetHT_run2017_red_cert_scan.root -b '+tag+catagory+str(int(j*1000))+' -H h_mass_passed_'+catagory+'_DeepCSV_'+str(format(j*1000,'.1f')))
      if 'CSVv2' in tag:
        os.system('python python/bTag_Add_2017.py -u '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESUP_Interpolation_rescale.root -d '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESDOWN_Interpolation_rescale.root -r '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JER_Interpolation_rescale.root -n '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_Nominal_Interpolation_rescale.root -g inputs/JetHT_run2017_red_cert_scan.root -b '+tag+catagory+str(int(j*1000))+' -H h_mass_passed_'+catagory+'_CSVv2_'+str(format(j*1000,'.1f')))
      if 'DeepJet' in tag:
        os.system('python python/bTag_Add_2017.py -u '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESUP_Interpolation_rescale.root -d '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JESDOWN_Interpolation_rescale.root -r '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_JER_Interpolation_rescale.root -n '+folder+'/ResonanceShapes_'+model+'_'+flavor+'_13TeV_Spring16_'+str(int(j*1000))+'_Nominal_Interpolation_rescale.root -g inputs/JetHT_run2017_red_cert_scan.root -b '+tag+catagory+str(int(j*1000))+' -H h_mass_passed_'+catagory+'_DeepJet_'+str(format(j*1000,'.1f')))
