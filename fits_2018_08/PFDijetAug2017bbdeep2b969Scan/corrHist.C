...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_PFDijetAug2017bbdeep2b969");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"p1_PFDijetAug2017bbdeep2b969");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"p2_PFDijetAug2017bbdeep2b969");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"p3_PFDijetAug2017bbdeep2b969");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_PFDijetAug2017bbdeep2b969");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"p1_PFDijetAug2017bbdeep2b969");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"p2_PFDijetAug2017bbdeep2b969");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"p3_PFDijetAug2017bbdeep2b969");
