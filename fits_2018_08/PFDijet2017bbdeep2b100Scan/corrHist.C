...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_PFDijet2017bbdeep2b100");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"p1_PFDijet2017bbdeep2b100");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"p2_PFDijet2017bbdeep2b100");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"p3_PFDijet2017bbdeep2b100");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_PFDijet2017bbdeep2b100");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"p1_PFDijet2017bbdeep2b100");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"p2_PFDijet2017bbdeep2b100");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"p3_PFDijet2017bbdeep2b100");
