...
#[0.1,0.15,0.2219,0.3,0.35,0.4,0.45,0.5, 0.5426,0.6, 0.6324,0.7,0.75,0.8, 0.8484, 0.8958, 0.9535]:
    box = 'PFNo34Dijet2017bbDeepJet%s%s'%(j,str(int(i*1000)))
    print box
    os.system('python python/Plot1DLimit.py -d cards_'+box+'_scan/ -m qq -b '+box+' -l 41.800 --massMin 1000 --massMax 8000 --xsecMin 1e-4 --xsecMax 1e2 -o exp')
    print '\n\n'
