...
Sample['RSG2qq'] = {
'0500':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_500GeV_0.root',
'1000':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_1000GeV_0.root',
'2000':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_2000GeV_0.root',
'3000':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_3000GeV_0.root',
'4000':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_4000GeV_0.root',
'5000':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_5000GeV_0.root',
'6000':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_6000GeV_0.root',
'7000':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_7000GeV_0.root',
'8000':'/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/TylerW/BTV/RSG2qq/RSG2qq_8000GeV_0.root',
...
if __name__=='__main__':
  ...
  histoB['2DpT-Eta'] = TH2D('2DpTEta_B','2DpTEta_B',100,0,5000,100,-3.14,3.14) 
  histo['2DpT-Eta'] = TH2D('2DpTEta','2DpTEta',100,0,5000,100,-3.14,3.14)
...
#  for tt in progressbar(range(1000),'Total'):
	...
	histo['2DpT-Eta'].Fill(tchain.jet_pt,tchain.jet_eta)
        FillHisto(tchain,histo['all'])
        if tchain.isB:
          FillHisto(tchain,histoB['all'])
	  histoB['2DpT-Eta'].Fill(tchain.jet_pt,tchain.jet_eta)
        if tchain.isC:
...
#          FillHisto(tchain,histoUDSG[pT])
  ...
  outcome = TFile('out.root','recreate')
  for j in VariableList:
    for i in Pt_Range[0:-1]+['all']:
      histo[i][j].Write()
      histoB[i][j].Write()
      histoC[i][j].Write()
  histo['2DpT-Eta'].Write()
  histoB['2DpT-Eta'].Write()
  outcome.Close()
