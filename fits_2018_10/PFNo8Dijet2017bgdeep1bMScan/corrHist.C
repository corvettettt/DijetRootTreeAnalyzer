...
//=========  (Fri Oct 26 04:06:03 2018) by ROOT version6.02/05
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_PFNo8Dijet2017bgdeep1bM");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"p1_PFNo8Dijet2017bgdeep1bM");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"p2_PFNo8Dijet2017bgdeep1bM");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"p3_PFNo8Dijet2017bgdeep1bM");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_PFNo8Dijet2017bgdeep1bM");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"p1_PFNo8Dijet2017bgdeep1bM");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"p2_PFNo8Dijet2017bgdeep1bM");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"p3_PFNo8Dijet2017bgdeep1bM");
