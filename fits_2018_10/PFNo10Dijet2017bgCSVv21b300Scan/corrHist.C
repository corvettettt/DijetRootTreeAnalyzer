...
//=========  (Thu Dec 13 11:15:34 2018) by ROOT version6.02/05
   ...
   correlation_matrix->SetBinContent(8,-0.9573508);
   correlation_matrix->SetBinContent(9,0.9967423);
   correlation_matrix->SetBinContent(10,1);
   correlation_matrix->SetBinContent(14,-0.9770981);
   correlation_matrix->SetBinContent(15,1);
   correlation_matrix->SetBinContent(16,0.9967423);
   correlation_matrix->SetBinContent(20,1);
   correlation_matrix->SetBinContent(21,-0.9770981);
   correlation_matrix->SetBinContent(22,-0.9573508);
   correlation_matrix->SetBinContent(25,1);
   correlation_matrix->SetBinError(8,0.9573508);
   correlation_matrix->SetBinError(9,0.9967423);
   correlation_matrix->SetBinError(10,1);
   correlation_matrix->SetBinError(14,0.9770981);
   correlation_matrix->SetBinError(15,1);
   correlation_matrix->SetBinError(16,0.9967423);
   correlation_matrix->SetBinError(20,1);
   correlation_matrix->SetBinError(21,0.9770981);
   correlation_matrix->SetBinError(22,0.9573508);
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_PFNo10Dijet2017bgCSVv21b300");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"p1_PFNo10Dijet2017bgCSVv21b300");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"p2_PFNo10Dijet2017bgCSVv21b300");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"p3_PFNo10Dijet2017bgCSVv21b300");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_PFNo10Dijet2017bgCSVv21b300");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"p1_PFNo10Dijet2017bgCSVv21b300");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"p2_PFNo10Dijet2017bgCSVv21b300");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"p3_PFNo10Dijet2017bgCSVv21b300");
