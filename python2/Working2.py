...
if __name__=='__main__':
  ...
  os.system('mkdir fits_2018_06')
  os.system('mkdir fits_2018_06/'+fit_dir)
...
#  os.system('python python/BinnedFit.py -c config/dijet.config -l 41800 -m '+model+' -s '+signal+' inputs/JetHT_run2016_moriond17_red_cert_v2_le1.root -b '+box+' -d fits_2018_06/'+fit_dir+' --fit-spectrum')
  ...
  os.system('python python/RunCombine_I_btag.py -m '+model+' -d '+out_dir+' --mass range\(1600,7000,100\) -c config/dijet.config -i fits_2018_06/'+fit_dir+'/DijetFitResults_'+box+'.root -b '+box+' --rMax 20 --xsec 1e-3 -l 41.800 --no-signal-sys')
  ...
  print 'python python/Plot1DLimit.py -d '+out_dir+'/ -m '+model+' -b '+box+' -l 41.800 --massMin 1000 --massMax 8000 --xsecMin 1e-4 --xsecMax 1e2'
