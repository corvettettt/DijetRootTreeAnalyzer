...
#    CSV_Value=[0.5,0.6,0.7,0.8,0.81, 0.82, 0.83, 0.84, 0.85, 0.86, 0.87, 0.88, 0.89, 0.90, 0.91, 0.92, 0.93, 0.94,0.95,0.96]
    ...
    for i,j in CSV_Value.items():
      ...
      hDict[i]["h_mass_passed_b"] = rt.TH1F(prefix+"_mass_passed_deepCSV_b",prefix+"_mass_passed_deepCSV_b",massRange[mass][0],massRange[mass][1],massRange[mass][2])
...
#    CSV_Value = [0.05,0.1,0.1522,0.2,0.25,0.3,0.35,0.4,0.45,0.4941,0.5803,0.6,0.65,0.7,0.75,0.8,0.85,0.8838,0.9693]
    ...
    outFolder = "signalHistos_"+flavour+'_Dec_ForScan_CSVv2_central_all'
    ...
    for i,j in CSV_Value.items():
      ...
      g_btag_pass[i]=rt.TGraphAsymmErrors() 
	...
	g_btag_pass[i].SetPoint(bin,mass,num/den)
    ...
    for i,j in CSV_Value.items(): 
      ...
      #g_btag_pass_Q.SetLineColor(rt.kRed)
...
#        g_2btag_rate_Q.Write("g_2btag_rate")
      ...
      g_btag_pass[i].Write('g_btag_pass')
