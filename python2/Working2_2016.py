...
if __name__=='__main__':
  ...
  content += 'python python/RunCombine_I_btag.py -m '+model+' -d '+out_dir+' --mass range\(1600,7000,100\) -c config/dijet.config -i fits_2018_10/'+fit_dir+'/DijetFitResults_'+box+'.root -b '+box+' --rMax 20 --xsec 1e-3 -l 36.000\n\n'
  ...
  os.system('python python/RunCombine_I_btag.py -m '+model+' -d '+out_dir+' --mass range\(1600,7000,100\) -c config/dijet.config -i fits_2018_10/'+fit_dir+'/DijetFitResults_'+box+'.root -b '+box+' --rMax 20 --xsec 1e-3 -l 36.000')
