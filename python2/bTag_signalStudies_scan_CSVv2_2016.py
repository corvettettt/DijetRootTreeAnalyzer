...
#    nnCSV_Value=[0.5,0.6,0.7,0.8,0.81, 0.82, 0.83, 0.84, 0.85, 0.86, 0.87, 0.88, 0.89, 0.90, 0.91, 0.92, 0.93, 0.94,0.95,0.96]
    ...
    for i in progressbar(range(nEntries), "Mass "+str(mass)+": ", 40):
        ...
        if (flavour == "bb" and (abs(tchain.jetpflavour_j1) != 5 or abs(tchain.jetpflavour_j2) != 5)):
            continue
        elif (flavour == "bg" and not ((abs(tchain.jetpflavour_j1) == 5 and abs(tchain.jetpflavour_j2) == 21) or (abs(tchain.jetpflavour_j1) == 21 and abs(tchain.jetpflavour_j2) == 5))):
            continue 
...
if __name__ == '__main__':
    ...
    outFolder = "Tag_signalHistos_"+flavour+'_Dec_For2016Scan_CSVv2'
