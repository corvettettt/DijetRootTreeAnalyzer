...
//=========  (Thu Sep 20 00:27:26 2018) by ROOT version6.02/05
   ...
   correlation_matrix->SetBinContent(7,8.783169e-11);
   correlation_matrix->SetBinContent(8,3.51961e-07);
   correlation_matrix->SetBinContent(9,8.800741e-11);
   correlation_matrix->SetBinContent(10,1);
   correlation_matrix->SetBinContent(13,0.998004);
   correlation_matrix->SetBinContent(14,0.0002610628);
   correlation_matrix->SetBinContent(15,1);
   correlation_matrix->SetBinContent(16,8.800741e-11);
   correlation_matrix->SetBinContent(19,0.0002605415);
   correlation_matrix->SetBinContent(20,1);
   correlation_matrix->SetBinContent(21,0.0002610628);
   correlation_matrix->SetBinContent(22,3.51961e-07);
   correlation_matrix->SetBinContent(25,1);
   correlation_matrix->SetBinContent(26,0.0002605415);
   correlation_matrix->SetBinContent(27,0.998004);
   correlation_matrix->SetBinContent(28,8.783169e-11);
   correlation_matrix->SetBinError(7,8.783169e-11);
   correlation_matrix->SetBinError(8,3.51961e-07);
   correlation_matrix->SetBinError(9,8.800741e-11);
   correlation_matrix->SetBinError(10,1);
   correlation_matrix->SetBinError(13,0.998004);
   correlation_matrix->SetBinError(14,0.0002610628);
   correlation_matrix->SetBinError(15,1);
   correlation_matrix->SetBinError(16,8.800741e-11);
   correlation_matrix->SetBinError(19,0.0002605415);
   correlation_matrix->SetBinError(20,1);
   correlation_matrix->SetBinError(21,0.0002610628);
   correlation_matrix->SetBinError(22,3.51961e-07);
   correlation_matrix->SetBinError(25,1);
   correlation_matrix->SetBinError(26,0.0002605415);
   correlation_matrix->SetBinError(27,0.998004);
   correlation_matrix->SetBinError(28,8.783169e-11);
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_PFNo3Dijet2017bbdeep2b650");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"p1_PFNo3Dijet2017bbdeep2b650");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"p2_PFNo3Dijet2017bbdeep2b650");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"p3_PFNo3Dijet2017bbdeep2b650");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_PFNo3Dijet2017bbdeep2b650");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"p1_PFNo3Dijet2017bbdeep2b650");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"p2_PFNo3Dijet2017bbdeep2b650");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"p3_PFNo3Dijet2017bbdeep2b650");
