...
//=========  (Thu Sep 20 02:25:31 2018) by ROOT version6.02/05
   ...
   correlation_matrix->SetBinContent(7,0.9979959);
   correlation_matrix->SetBinContent(8,-0.9999995);
   correlation_matrix->SetBinContent(9,0.9999777);
   correlation_matrix->SetBinContent(10,1);
   correlation_matrix->SetBinContent(13,0.9983777);
   correlation_matrix->SetBinContent(14,-0.9999772);
   correlation_matrix->SetBinContent(15,1);
   correlation_matrix->SetBinContent(16,0.9999777);
   correlation_matrix->SetBinContent(19,-0.9979954);
   correlation_matrix->SetBinContent(20,1);
   correlation_matrix->SetBinContent(21,-0.9999772);
   correlation_matrix->SetBinContent(22,-0.9999995);
   correlation_matrix->SetBinContent(25,1);
   correlation_matrix->SetBinContent(26,-0.9979954);
   correlation_matrix->SetBinContent(27,0.9983777);
   correlation_matrix->SetBinContent(28,0.9979959);
   correlation_matrix->SetBinError(7,0.9979959);
   correlation_matrix->SetBinError(8,0.9999995);
   correlation_matrix->SetBinError(9,0.9999777);
   correlation_matrix->SetBinError(10,1);
   correlation_matrix->SetBinError(13,0.9983777);
   correlation_matrix->SetBinError(14,0.9999772);
   correlation_matrix->SetBinError(15,1);
   correlation_matrix->SetBinError(16,0.9999777);
   correlation_matrix->SetBinError(19,0.9979954);
   correlation_matrix->SetBinError(20,1);
   correlation_matrix->SetBinError(21,0.9999772);
   correlation_matrix->SetBinError(22,0.9999995);
   correlation_matrix->SetBinError(25,1);
   correlation_matrix->SetBinError(26,0.9979954);
   correlation_matrix->SetBinError(27,0.9983777);
   correlation_matrix->SetBinError(28,0.9979959);
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_PFNo3Dijet2017bgdeeple1b969");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"p1_PFNo3Dijet2017bgdeeple1b969");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"p2_PFNo3Dijet2017bgdeeple1b969");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"p3_PFNo3Dijet2017bgdeeple1b969");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_PFNo3Dijet2017bgdeeple1b969");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"p1_PFNo3Dijet2017bgdeeple1b969");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"p2_PFNo3Dijet2017bgdeeple1b969");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"p3_PFNo3Dijet2017bgdeeple1b969");
