...
#    h_deltaphi = TH1F('DeltaPhi','DeltaPhi',50,0,3.14)
    ...
    for i in flist.readlines():
        tchain.Add('/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/juska/moriond17_red_cert_v2/moriond17_v2_37fb_1nd_s15_20170127_164251/'+i.replace('\n','').replace('\t',''))
...
#          if tchain.jetCSVAK4_j1 > j/1000 and tchain.jetCSVAK4_j2 > j/1000 :
#            h_mjj2[j].Fill(mjj)
	  if tchain.jetCSVAK4_j1 > j/1000:
	    NofB +=1
	  if tchain.jetCSVAK4_j2 > j/1000:
	    NofB += 1
          if tchain.jetDeepCSVAK4_j1 > j/1000.0:
	    NofDB +=1 
          if tchain.jetDeepCSVAK4_j2 > j/1000.0:
	    NofDB +=1
