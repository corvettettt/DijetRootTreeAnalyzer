...
//=========  (Thu Jul 26 16:30:58 2018) by ROOT version6.02/05
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_Dijet2017ScanbbCSV2b750");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"p1_Dijet2017ScanbbCSV2b750");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"p2_Dijet2017ScanbbCSV2b750");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"p3_Dijet2017ScanbbCSV2b750");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_Dijet2017ScanbbCSV2b750");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"p1_Dijet2017ScanbbCSV2b750");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"p2_Dijet2017ScanbbCSV2b750");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"p3_Dijet2017ScanbbCSV2b750");
